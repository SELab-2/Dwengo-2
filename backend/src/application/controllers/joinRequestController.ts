...
const extractors = {
  getJoinRequest: createParamsExtractor(JoinRequestServices.GetJoinRequestsParams, {'_userId': 'idParent', '_requestId': 'id'}, {}, []),
  ...
  create: createParamsExtractor(JoinRequestServices.CreateJoinRequestParams, {'_requesterId': 'requester', '_classId': 'class', '_type': 'type'}, {}, [])
}
...
export class JoinRequestController extends Controller {
  constructor(
    ...
    const handlers: RouteHandlers = {
      [HttpMethod.GET]: [
        { parent: 'users', hasId: true, hasParentId: true, extractor: extractors.getJoinRequest,
          handler: (req: Request, data: ServiceParams) => this.getOne(req, data) },
        { parent: 'users', hasId: false, hasParentId: true, extractor: extractors.getJoinRequests,
          handler: (req: Request, data: JoinRequestServices.GetJoinRequestsParams) => this.getChildren(req, data, getJoinRequests) },
      ],
      [HttpMethod.DELETE]: [
