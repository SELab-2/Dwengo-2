...
//     getAssignmentQuestions: createParamsExtractor(
//         QuestionThreadServices.GetAssignmentQuestionThreadsParams,
//         { _assignmentId: "idParent" },
//         {},
//         [],
//     ),
//     update: createParamsExtractor(QuestionThreadServices.UpdateQuestionThreadParams, { _id: "id" }, {}, [
//         "__isClosed",
//         "_visibility",
//     ]),
//     remove: createParamsExtractor(QuestionThreadServices.DeleteQuestionThreadParams, { _id: "id" }, {}, []),
//     create: createParamsExtractor(
//         QuestionThreadServices.CreateQuestionThreadParams,
//         {
//             _assignmentId: "idParent",
//             _creatorId: "creator",
//             learningObjectId: "learningObject",
//             isClosed: "closed",
...
//                     hasId: false,
//                     hasParentId: true,
//                     extractor: extractors.getAssignmentQuestions,
//                     handler: (req: Request, data: QuestionThreadServices.GetAssignmentQuestionThreadsParams) =>
//                         this.getChildren(req, data, getAssignmentQuestions),
//                 },
//             ],
//             [HttpMethod.PATCH]: [
//                 {
