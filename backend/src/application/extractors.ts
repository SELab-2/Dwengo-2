...
export function createParamsExtractor<T extends ServiceParams>(
    ...
    return (req: Request): T => {
        ...
        for (const paramInfo of paramInfos) {
            ...
            if (req.body && mappedName in req.body && req.body[mappedName] !== undefined) value = req.body[mappedName];
            ...
            else if (mappedName in query && query[mappedName] !== undefined) value = query[mappedName];
