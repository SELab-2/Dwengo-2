...
import { AssignmentOversightComponent } from './components/assignment-oversight/assignment-oversight.component';
...
export const routes: Routes = [
    ...
    { path: 'student/assignments', component: AssignmentOversightComponent, title: "My Assignments", canActivate: [UserTypeGuard], data: { userType: 'student' } },
    { path: 'teacher/assignments', component: AssignmentOversightComponent, title: "My Assignments", canActivate: [UserTypeGuard], data: { userType: 'teacher' } },
